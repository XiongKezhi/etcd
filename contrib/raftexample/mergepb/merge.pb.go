...
const (
	...
	MergeTry       MergeMessageType = 3
	MergeRedirect  MergeMessageType = 4
)
...
type Node struct {
	...
	MergePort uint32 `protobuf:"varint,3,req,name=MergePort" json:"MergePort"`
	RaftPort  uint32 `protobuf:"varint,4,req,name=RaftPort" json:"RaftPort"`
}
...
type TryRequest struct {
	Id      uint64  `protobuf:"varint,1,req,name=Id" json:"Id"`
	Cluster Cluster `protobuf:"bytes,2,req,name=Cluster" json:"Cluster"`
}
...
func (m *TryResponse) Reset()         { *m = TryResponse{} }
func (m *TryResponse) String() string { return proto.CompactTextString(m) }
func (*TryResponse) ProtoMessage()    {}
func (*TryResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_82caea6f5430298b, []int{5}
}
func (m *TryResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TryResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TryResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TryResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TryResponse.Merge(m, src)
}
func (m *TryResponse) XXX_Size() int {
	return m.Size()
}
func (m *TryResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_TryResponse.DiscardUnknown(m)
}

var xxx_messageInfo_TryResponse proto.InternalMessageInfo
...
func (*RefreshRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_82caea6f5430298b, []int{8}
}
...
func (*RefreshResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_82caea6f5430298b, []int{9}
}
...
func init() {
	...
	proto.RegisterType((*TryRequest)(nil), "mergepb.TryRequest")
	proto.RegisterType((*TryResponse)(nil), "mergepb.TryResponse")
...
var fileDescriptor_82caea6f5430298b = []byte{
	...
	,
}
...
func (m *TryRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TryRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TryRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *TryResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TryResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TryResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *TryRequest) Unmarshal(dAtA []byte) error {
	var hasFields [1]uint64
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TryRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TryRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *TryResponse) Unmarshal(dAtA []byte) error {
	var hasFields [1]uint64
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TryResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TryResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
